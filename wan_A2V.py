...
# Diffusion Models
download_from_hf_url(url="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_s2v_14B_fp8_scaled.safetensors",outdir="/workspace/ComfyUI/models/diffusion_models")
download_from_hf_url(url="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_s2v_14B_bf16.safetensors",outdir="/workspace/ComfyUI/models/diffusion_models")
 #audio_encoders
download_from_hf_url(url="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/audio_encoders/wav2vec2_large_english_fp16.safetensors",outdir="/workspace/ComfyUI/models/audio_encoders")

 #lora
download_from_hf_url(url="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors",outdir="/workspace/ComfyUI/models/loras")
